...
import { MapPin, Clock, Briefcase, CheckCircle2, ArrowLeft, UploadCloud, Send, Check } from "lucide-react";
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 bg-[#F8FAFC] border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs lg:sticky lg:top-28">
              {!submitted ? (
